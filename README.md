...
<p align="center">
  Lista de Compras é um projeto de desafio do curso <a href="https://app.rocketseat.com.br/journey/full-stack/overview" target="_blank" rel="noopener noreferrer">Full-Stack da RocketSeat</a> onde construimos uma simples página funcionalidade de JavaScript. O desafio incentiva o aluno a se esforçar sozinho para construir o projeto.
</p>
...
## 🎯 Objective
O objetivo do desafio é construir uma simples página funcional de lista de itens com JavaScript. Eu resolvi implementar algumas **Features** a mais para deixar mais completo o projeto.
...
- [x] LocalStorage
      - Os itens da lista são salvos localmente no navegador do usuário, permitindo que a lista persista entre sessões.
- [x] Animação simplescom com JS
      - Implementei uma simples rotação 3D quando o item for deletado, enquanto modifica o layout e um delay de 2,5 segundos antes de ele sumir.
- [x] Mobile até 390px
